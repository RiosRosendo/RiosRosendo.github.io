...
window.PORTFOLIO = {
  ...
  t: {
    es: {
      ...
      aboutBody: "Ingeniero en Robótica y Sistemas Digitales graduado del Tec de Monterrey. He colaborado con John Deere en sistemas embebidos autónomos y realicé una pasantía de investigación en AIST Japón desarrollando interfaces de teleoperación para robots manipuladores.\n\nTrabajo en la intersección entre hardware y software: desde firmware con FreeRTOS hasta percepción 3D, SLAM y visión por computadora — siempre con prototipos funcionales como resultado.",
    ...
    en: {
      ...
      aboutBody: "Robotics and Digital Systems Engineer graduated from Tec de Monterrey. I collaborated with John Deere on autonomous embedded systems and completed a research internship at AIST Japan building teleoperation interfaces for robotic manipulators.\n\nI work at the intersection of hardware and software — from FreeRTOS firmware to 3D perception, SLAM and computer vision — always delivering functional prototypes.",
